...
public class GetUserLike {
    ...
    public GetUserLike(final FragmentActivity contexts, final AsyncTwitter asyncTwitterd, final TweetListItemAdapter adapter, final ICallBack callBack) {
    ...
    public void getFavorites(final long id) {
        mode = false;
        Paging paging = new Paging();
        paging.setCount(200);
        asyncTwitter.getFavorites(id, paging);
    }

    public void getFutureFavorites(final long id, final long sinceId) {
        mode = false;
        Paging paging = new Paging();
        paging.setCount(200);
    ...
    public void getOldFavorites(final long id, final long maxId) {
        mode = true;
        Paging paging = new Paging();
        paging.setCount(200);
