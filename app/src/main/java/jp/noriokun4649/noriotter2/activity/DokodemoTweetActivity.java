...
public class DokodemoTweetActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable final Bundle savedInstanceState) {
        ...
        if (permissionCheck != PackageManager.PERMISSION_GRANTED) {
            ...
            ab.setNegativeButton("OK", (dialog, which) -> ActivityCompat.requestPermissions(DokodemoTweetActivity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, REQUEST_CODE_PLEASE_GRANT_PERMISSION));
            ab.show();
        }
        ...
        button4.setOnClickListener(view -> startOverlay(false));
        Button button8 = findViewById(R.id.button8);
        button8.setOnClickListener(v -> stopService(new Intent(DokodemoTweetActivity.this, OverrideView.class)));
        ...
        button6.setOnClickListener(v -> startActivity(new Intent(DokodemoTweetActivity.this, ScreenConectActivity.class)));
        Button button7 = findViewById(R.id.button7);
        button7.setOnClickListener(v -> {
            final SharedPreferences sharedPreferences1 = PreferenceManager.getDefaultSharedPreferences(DokodemoTweetActivity.this);
            ...
            ab.setItems(a, (dialog, which) -> {
                switch (which) {
                    case 0:
                        ...
                        abin.setItems(abin_item, (dialog1, which1) -> {
                            switch (which1) {
                                case 0:
                            ...
                            Log.d("inFormat", " int:" + sharedPreferences1.getInt("informat", PixelFormat.RGBA_8888));
                        });
                        abin.show();
                        break;
                    case 1:
                        ...
                        about.setItems(about_item, (dialog12, which12) -> editor.putInt("outformat", which12).apply());
                        about.show();
                        break;
                }
            });
